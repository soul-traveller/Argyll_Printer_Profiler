...
Argyll_Printer_Profiler.command is an interactive Bash script that automates a complete **ArgyllCMS printer profiling workflow** on macOS, Linux and Windows, from target generation to ICC installation.<br>
